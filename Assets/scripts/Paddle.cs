...
class Paddle : MonoBehaviour
{
    ...
    //Method which gives the paddle movement if conditions (if keys are pressed) are met 
    public  void Update()
    {
    ...
    void OnCollisionEnter2D(Collision2D col)//Method for the paddle to restrict movement beyond the barriers 
    {
