...
// This class describes the movement of the ball and sets conditions for when it hits bricks and  the barriers. 
class ball : MonoBehaviour
{
    ...
    // This method is called whenever the ball hits something. It is given the col parameter 
    //which conatins information about the collision and what it collided with. 
    void OnCollisionEnter2D(Collision2D col)

    { 
    

        // Switch statement which compares the  gameobject  to the cases named within the statement 
